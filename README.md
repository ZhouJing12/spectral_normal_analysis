Applying Ljung Box and Jarque Bera algorithm to test goodness of matching a normal distribution in GILDAS/CLASS program. Using this code can remove bad scans of observation.
